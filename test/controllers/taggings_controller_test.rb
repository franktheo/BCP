...
class TaggingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tagging" do
    assert_difference('Tagging.count') do
      post taggings_url, params: { tagging: { entity_id: @tagging.entity_id, entity_type: @tagging.entity_type, tag: @tagging.tag } }
    end
  ...
  test "should update tagging" do
    patch tagging_url(@tagging), params: { tagging: { entity_id: @tagging.entity_id, entity_type: @tagging.entity_type, tag: @tagging.tag } }
